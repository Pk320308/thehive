...
import org.thp.cynox.dto.v1.{InputAlert, OutputAlert}
import org.thp.cynox.models._
import org.thp.cynox.services.AlertSrv
  ...
  "alert controller" should {
    ...
    "get an alert" in testApp { app =>
      ...
      app.apply[Database].roTransaction { implicit graph =>
        ...
        val request = FakeRequest("GET", s"/api/v1/alert/${alert._id}").withHeaders("user" -> "socuser@cynox.local")
