...
import org.thp.cynox.dto.v0.OutputCaseTemplate
import org.thp.cynox.services.CaseTemplateOps._
import org.thp.cynox.services.CaseTemplateSrv
...
//  val dummyUserSrv = DummyUserSrv(userId = "admin@cynox.local", permissions = Permissions.all)
