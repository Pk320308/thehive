...
import org.thp.cynox.dto.v1.{InputCase, OutputCase, OutputCustomFieldValue}
  ...
  "case controller" should {
    ...
    "create a new case using a template" in testApp { app =>
      ...
      val expected = TestCase(
        ...
        status = "Open",
        summary = None,
        user = Some("certuser@cynox.local"),
        customFields = Seq(
