...
import org.thp.cynox.services.Connector
import org.thp.cynox.{TestAppBuilder, CynoxModule}
    ...
    "return proper status" in testApp { app =>
      ...
      val expectedJson = Json.obj(
        "versions" -> Json.obj(
          ...
          "Cynox"     -> getVersion(classOf[CynoxModule]),
        ...
        "schemaStatus" -> Json.arr(
          Json.obj("name" -> "cynox", "currentVersion" -> 99, "expectedVersion" -> 99, "error" -> JsNull)
        )
      )
