...
import org.thp.cynox.models.{Case, CaseStatus, Permissions}
import org.thp.cynox.services.{CaseSrv, FlowActor, OrganisationSrv}
...
class AuditCtrlTest extends PlaySpecification with TestAppBuilder {
  ...
  val authContext: AuthContext = DummyUserSrv(userId = "certuser@cynox.local", organisation = "cert", permissions = Permissions.all).authContext
