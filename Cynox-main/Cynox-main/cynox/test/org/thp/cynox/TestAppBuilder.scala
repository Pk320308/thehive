...
import org.thp.cynox.services.notification.notifiers.{AppendToFileProvider, EmailerProvider, NotifierProvider}
import org.thp.cynox.services.notification.triggers._
import org.thp.cynox.services.{UserSrv => _, _}
...
trait TestAppBuilder {
  ...
  def appConfigure: AppBuilder =
    (new AppBuilder)
      ...
      .bind[Schema, CynoxSchemaDefinition]
      .bindToProvider[TypedActorRef[CaseNumberActor.Request], TestNumberActorProvider]
      .multiBind[UpdatableSchema](classOf[CynoxSchemaDefinition])
      .bindNamed[QueryExecutor, CynoxQueryExecutor]("v0")
      ...
      .addConfiguration("play.modules.disabled = [org.thp.scalligraph.ScalligraphModule, org.thp.cynox.CynoxModule]")
