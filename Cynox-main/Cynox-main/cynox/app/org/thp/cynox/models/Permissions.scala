...
object Permissions extends Perms {
  lazy val accessCynoxFS: PermissionDesc          = PermissionDesc("accessCynoxFS", "Access to CynoxFS", "organisation")
  ...
  lazy val managePlatform: PermissionDesc           = PermissionDesc("managePlatform", "Manage Cynox platform", "admin")
