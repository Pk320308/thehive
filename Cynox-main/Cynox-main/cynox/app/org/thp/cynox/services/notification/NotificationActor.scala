package org.thp.cynox.services.notification
...
import org.thp.cynox.models.{Audit, Organisation, User}
...
import org.thp.cynox.services.notification.notifiers.{Notifier, NotifierProvider}
import org.thp.cynox.services.notification.triggers.{Trigger, TriggerProvider}
...
class NotificationActor @Inject() (
  ...
  /**
    ...
    * related to the host, not to the user. When Cynox is executed in a cluster, a role can be assigned to each host.
