...
import org.thp.cynox.controllers.v0.AuditRenderer
import org.thp.cynox.controllers.v0.Conversion.fromObjectType
import org.thp.cynox.models._
import org.thp.cynox.services.AlertOps._
import org.thp.cynox.services.AuditOps._
...
import org.thp.cynox.services.{AuditSrv, _}
...
case class WebhookNotification(
  ...
  def organisationAuthorised(organisation: Organisation): Boolean =
    (includedCynoxOrganisations.contains("*") ||
      includedCynoxOrganisations.isEmpty ||
      includedCynoxOrganisations.contains(organisation.name)) &&
      !excludedCynoxOrganisations.contains(organisation.name)
}
...
class Webhook(
  ...
  object v1 {
    import org.thp.cynox.controllers.v1.Conversion._
  ...
  // The custom field type is added to match Cynox 3 webhook format.
