...
import org.thp.cynox.controllers.v0.{QueryExecutorVersion0Provider, CynoxQueryExecutor => CynoxQueryExecutorV0}
import org.thp.cynox.controllers.v1.{CynoxQueryExecutor => CynoxQueryExecutorV1}
import org.thp.cynox.models.{CynoxSchemaDefinition, UseHashToIndex}
import org.thp.cynox.services.notification.NotificationActor
import org.thp.cynox.services.notification.notifiers._
import org.thp.cynox.services.notification.triggers._
import org.thp.cynox.services.{Connector, LocalKeyAuthProvider, LocalPasswordAuthProvider, LocalUserSrv, UserSrv => _, _}
...
class CynoxModule(environment: Environment, configuration: Configuration) extends AbstractModule with ScalaModule with AkkaGuiceSupport {
...
//    bind[AuthSrv].toProvider[MultiAuthSrvProvider]
    ...
    routerBindings.addBinding.toProvider[CynoxRouter]
    val queryExecutorBindings = ScalaMultibinder.newSetBinder[QueryExecutor](binder)
    queryExecutorBindings.addBinding.to[CynoxQueryExecutorV0]
    queryExecutorBindings.addBinding.to[CynoxQueryExecutorV1]
    ...
    schemaBindings.addBinding.to[CynoxSchemaDefinition]
