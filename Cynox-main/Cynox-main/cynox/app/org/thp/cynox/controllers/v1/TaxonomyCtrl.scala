...
import org.thp.cynox.dto.v1.InputTaxonomy
import org.thp.cynox.models.{Permissions, RichTaxonomy, Tag, Taxonomy}
import org.thp.cynox.services.TaxonomyOps._
import org.thp.cynox.services.{TagSrv, TaxonomySrv}
...
class TaxonomyCtrl @Inject() (
  ...
  private def createFromInput(inputTaxo: InputTaxonomy)(implicit graph: Graph, authContext: AuthContext): Try[RichTaxonomy] = {
    ...
    if (inputTaxo.namespace.isEmpty)
      ...
      Failure(BadRequestError(s"Namespace _freetags is restricted for Cynox"))
