...
import org.thp.cynox.controllers.v0.{QueryCtrl => QueryCtrlV0}
import org.thp.cynox.services.{CustomFieldSrv, ImpactStatusSrv, ResolutionStatusSrv}
...
//    pageCtrl: PageCtrl,
  ...
  def describeCortexEntity(
      ...
      initialQuery: String,
      className: String,
      packageName: String = "org.thp.cynox.connector.cortex.controllers.v0"
