(function() {
    ...
    angular.module('cynoxControllers').controller('OrgUserModalCtrl', function($scope, $uibModalInstance, OrganisationSrv, UserSrv, NotificationSrv, organisation, user, profiles, isEdit) {
        var self = this;
