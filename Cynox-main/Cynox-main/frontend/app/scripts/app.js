...
angular.module('cynox', [
    ...
    .config(function ($httpProvider) {
        ...
        $httpProvider.defaults.xsrfCookieName = 'CYNOX-XSRF-TOKEN';
        $httpProvider.defaults.xsrfHeaderName = 'X-CYNOX-XSRF-TOKEN';
        $httpProvider.interceptors.push(function ($rootScope, $q) {
            ...
            return {
                ...
                responseError: function (rejection) {
                    ...
                    if (rejection.status === 502 || rejection.status === 503 || rejection.status === 504) {
