...
import org.thp.cynox.connector.cortex.models.{ActionOperationStatus, Job, JobStatus, CynoxCortexSchemaProvider}
...
import org.thp.cynox.services.notification.triggers.JobFinished
    ...
    "handle creation and then finished job" in testApp { app =>
      ...
      app[Database].roTransaction { implicit graph =>
        ...
        for {
          ...
          user         <- app[UserSrv].startTraversal.getByName("certadmin@cynox.local").getOrFail("User")
