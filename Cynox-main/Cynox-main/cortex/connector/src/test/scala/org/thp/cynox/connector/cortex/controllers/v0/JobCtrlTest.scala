...
import org.thp.cynox.connector.cortex.services.{Connector, CortexActor, TestConnector}
    ...
    super
      ...
      .`override`(
        _.bindActor[CortexActor]("cortex-actor")
          ...
          .bindNamedToProvider[QueryExecutor, CynoxCortexQueryExecutorProvider]("v0")
      )
