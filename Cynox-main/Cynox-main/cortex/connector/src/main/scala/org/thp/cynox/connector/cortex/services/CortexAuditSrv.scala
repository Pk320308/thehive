...
import org.thp.cynox.connector.cortex.models.{Action, AnalyzerTemplate, Job}
import org.thp.cynox.models.Observable
import org.thp.cynox.services.{AuditSrv, UserSrv}
