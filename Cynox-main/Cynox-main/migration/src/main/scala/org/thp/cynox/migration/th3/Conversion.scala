package org.thp.cynox.migration.th3

import akka.NotUsed
import akka.stream.scaladsl.Source
import akka.util.ByteString
import org.thp.scalligraph.utils.Hash
import org.thp.cynox.connector.cortex.models.{Action, Job, JobStatus}
import org.thp.cynox.controllers.v0
...
trait Conversion {
  ...
  implicit val metaDataReads: Reads[MetaData] =
    ((JsPath \ "_id").read[String] and
      (JsPath \ "createdBy").readWithDefault[String]("system@cynox.local").map(normaliseLogin) and
