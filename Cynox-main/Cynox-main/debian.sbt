...
linuxPackageMappings in Debian += packageMapping(file("LICENSE") -> "/usr/share/doc/cynox/copyright").withPerms("644")
name in Debian := "cynox4"
version in Debian := {
  version.value match {
